# Narrative draft — all ten chapters (Stage 2, for Gate C review)

*Drafted 2026-07-14 from `research/history-brief.md`; every claim traces to that brief or to `stage1/DATA-LOG.md`. Word target 150–300 per narrative chapter (PLAN §4). Map-state lines are build instructions, not display text. Source keys resolve on the sources-and-methods page.*
...
*Fact-check notes for Gate C: all figures verified against `research/history-brief.md` on 2026-07-14. Deliberately excluded per PLAN §1: the 90% antiparochi figure (stated only to correct it), any per-capita green m² number, the "WHO 9 m²" standard, the anti-communist homeownership thesis, and "Europe's highest homeownership rate." The "two in three" Municipality of Athens figure is the Stage-1 computation (66.5%, 2021 Table 6); "nearly half" national is 46.8% (2011) cross-validated at 45.2% of dwellings (2021). The ~3% public-construction share and the 940-firms/1.3-average figures carry single-source flags in the brief; both are attributed in-text ("by one estimate", "an archival sample").*
